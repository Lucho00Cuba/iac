...
resource "null_resource" "k0sctl" {
  ...
  provisioner "local-exec" {
    command = "ANSIBLE_HOST_KEY_CHECKING=False ansible-playbook -u root -i /home/lucho/00/IaC/ansible/hosts /home/lucho/00/IaC/ansible/docker/docker-playbook.yml"
  }
